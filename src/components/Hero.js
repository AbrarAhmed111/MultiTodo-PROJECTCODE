 ...
 const toggle = (index) => {
  ...
  return (
    <div id='main-div' className='background-image min-vh-100 pt-5 px-2 '>
      <Container md={6} id='main-container' className='rounded-top-1  col-sm-12 col-md-6 col-lg-6 col-xl-4  justify-content-center align-items-center d-flex flex-column py-3'>
        <Row>
          <h1>Nested Todo</h1>
        </Row>
